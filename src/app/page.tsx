  ...
  const [scheduledPosts, setScheduledPosts] = useState<ScheduledPost[]>([
    {
      ...
      hook: 'POV: using AI search to turn 40 science papers into an exact workout split in 4 seconds',
      caption: 'Why spend 4 hours digging through tabs in 2026?\n\nAutomate research and instant workflows in 1 click.\n\n⚡ Link in bio to test it free!',
      hashtags: ['#aiworkflows', '#techhacks', '#productivity', '#fyp'],
      scheduledDate: 'Today',
      scheduledTime: '6:30 PM (Peak)',
      status: 'scheduled',
      viewsForecast: 'Scheduled',
      channel: 'instagram',
    },
    {
      id: 'sched_initial_2',
      ...
      hook: 'me explaining how one prompt connects research, docs, and workflows automatically',
      caption: 'The secret weapon creators use to automate workflows while sleeping.\n\nSave this reel for your next project 📌\n\nLink in bio 👇',
      hashtags: ['#growthhacks', '#founder', '#indiehacker', '#reels'],
